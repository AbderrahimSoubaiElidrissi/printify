          ...
          <div className="flex flex-col justify-between h-full md:relative mx-auto  lg:px-6">
            ...
            <ul className="list-reset flex flex-row md:flex-col text-center md:text-left ">
              <li className="mr-3 flex-1 ">
                <Link href="/">
                  <a className="group block py-1 md:py-3 pl-1 align-middle  no-underline ">
              ...
              <li className="mr-3 flex-1  text-indigo-400">
                <Link href="/queue">
                  <a className="group block py-1 md:py-3 pl-1 align-middle  no-underline hover:text-indigo-400 ">
